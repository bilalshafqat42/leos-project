export const services = [
  {
    ...
    description:
      "Complete villa transformations planned around your lifestyle, from structural improvements and MEP upgrades to refined final finishes.",
    scope: "Planning · Civil Works · Finishes",
    image: "/images/hero.avif",
    imagePosition: "58% center",
    featured: true,
    overview: [
      "A villa renovation touches every part of daily life, from how a family moves through the home to how it feels in the evening light. We plan around that reality, sequencing structural work, MEP upgrades and finishes as one coordinated programme rather than a string of separate trades.",
      "You keep one point of contact throughout, with scope, schedule and budget agreed before the first wall comes down, and a full walkthrough and warranty at handover.",
    ],
    highlights: [
      "Full structural and layout assessment",
      "MEP upgrades: electrical, plumbing and HVAC",
      "Custom joinery and premium finishes",
      "Landscaping and exterior coordination",
    ],
  },
  {
    number: "02",
    ...
    overview: [
      ...
      "Layouts are planned for practical daily use first, then refined with fixtures and finishes chosen to hold up to daily wear.",
    ],
    highlights: [
      "Layout planning for practical, comfortable flow",
      "Waterproofing and plumbing renewal",
      "Tiling, sanitaryware and fixture installation",
  ...
  },
  {
    ...
    overview: [
      ...
      "From initial layout through joinery, lighting and final connections, one team stays accountable for the result.",
    ],
    highlights: [
      "Space planning and cabinetry design",
      "Worktop, splashback and appliance coordination",
  ...
  },
  {
    ...
    overview: [
      ...
      "The result is a smarter, more comfortable space with every finish and system considered together, not resolved room by room.",
    ],
    highlights: [
      "Interior layout optimisation",
      "MEP servicing and compliance checks",
      "Flooring, joinery and finishes",
      "Building management coordination and handover",
    ],
  },
  {
    number: "05",
    ...
    highlights: [
      "Scope definition and programme planning",
      "Contractor and supplier procurement",
      "Budget tracking and cost control",
      "Quality supervision through to handover",
    ],
  },
  {
    number: "06",
    ...
    highlights: [
      "Workflow and space utilisation review",
      "Phased works to minimise business disruption",
      "MEP and technology infrastructure upgrades",
      "Finishes aligned with brand identity",
    ],
  },
  {
    number: "07",
    ...
    highlights: [
      ...
      "Partitioning, ceilings and flooring installation",
      "MEP, IT and AV infrastructure delivery",
      "Furniture coordination and final handover",
    ],
  },
];
